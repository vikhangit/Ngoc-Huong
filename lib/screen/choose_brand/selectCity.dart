...
class SelectCity extends StatefulWidget {
  ...
  const SelectCity({super.key, required this.saveAddress});

  @override
  State<SelectCity> createState() => _ModalDiaDiemState();
}

String valueSearch = "";

class _ModalDiaDiemState extends State<SelectCity> {
  ...
  void changeAddress(String id, String name) {
    if (provinceId == id && activeCity == name) {
      setState(() {
        provinceId = "";
        activeCity = "";
      });
