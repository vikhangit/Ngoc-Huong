                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              return FutureBuilder(
                                future:
                                    callPBLApiStatus(profile[0]["ma_kh"], "0"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasData) {
                        ...
                        FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              return FutureBuilder(
                                future:
                                    callPBLApiStatus(profile[0]["ma_kh"], "1"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasData) {
                                    if (snapshot.data!.isNotEmpty) {
                                      List list = snapshot.data!;
                        ...
                        FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              return FutureBuilder(
                                future:
                                    callPBLApiStatus(profile[0]["ma_kh"], "3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasData) {
                                    if (snapshot.data!.isNotEmpty) {
                                      List list = snapshot.data!;
                        ...
                        FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              return FutureBuilder(
                                future:
                                    callPBLApiStatus(profile[0]["ma_kh"], "6"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasData) {
                                    if (snapshot.data!.isNotEmpty) {
                                      List list = snapshot.data!;
                        ...
                        FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              return FutureBuilder(
                                future:
                                    callPBLApiStatus(profile[0]["ma_kh"], "9"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasData) {
                                    if (snapshot.data!.isNotEmpty) {
                                      List list = snapshot.data!;
